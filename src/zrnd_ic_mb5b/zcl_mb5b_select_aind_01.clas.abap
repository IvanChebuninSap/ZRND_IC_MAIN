CLASS ZCL_MB5B_SELECT_AIND_01 DEFINITION
  PUBLIC
...
TYPES: BEGIN OF stype_aind_str1,                            "n1481757
         archindex TYPE aind_str1-archindex,                "n1481757
         itype     TYPE aind_str1-itype,                    "n1481757
         skey      TYPE aind_str1-skey,                     "n1481757
       END OF stype_aind_str1.                              "n1481757

    TYPES   ltt_output TYPE STANDARD TABLE OF stype_aind_str1.
...
CLASS ZCL_MB5B_SELECT_AIND_01 IMPLEMENTATION.
