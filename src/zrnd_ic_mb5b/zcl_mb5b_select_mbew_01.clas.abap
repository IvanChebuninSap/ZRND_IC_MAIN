CLASS zcl_mb5b_select_mbew_01 DEFINITION
  PUBLIC
  ...
  PROTECTED SECTION.
    ...
    METHODS move_to_output
         REDEFINITION .
  PRIVATE SECTION.
    TYPES : BEGIN OF lty_output,                            "n450764
              matnr     TYPE zmbew-matnr,                   "n450764
              bwkey     TYPE zmbew-bwkey,                   "n450764
              bwtar     TYPE zmbew-bwtar,                   "n450764
              lbkum(09) TYPE p DECIMALS 3,                  "n450764
              salk3(09) TYPE p DECIMALS 2,                  "n450764
              meins     TYPE zmara-meins,                   "n450764
              waers     TYPE zt001-waers,                   "n450764
              bwtty     TYPE zmbew-bwtty,                   "n1227439
...
CLASS ZCL_MB5B_SELECT_MBEW_01 IMPLEMENTATION.
