CLASS zcl_mb5b_select_makt_01 DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    ...
    TYPES : BEGIN OF stype_makt,                            "n451923
              matnr TYPE zmakt-matnr,                       "n451923
              maktx TYPE zmakt-maktx,                       "n451923
            END OF stype_makt.


    TYPES   ltt_output TYPE STANDARD TABLE OF stype_makt.
...
CLASS zcl_mb5b_select_makt_01 IMPLEMENTATION.
