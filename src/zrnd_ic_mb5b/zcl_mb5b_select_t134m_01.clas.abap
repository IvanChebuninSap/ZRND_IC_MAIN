CLASS zcl_mb5b_select_t134m_01 DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    ...
    TYPES : BEGIN OF lty_output,                            "n451923
              bwkey TYPE zt134m-bwkey,
              mtart TYPE zt134m-mtart,
              mengu TYPE zt134m-mengu,
              wertu TYPE zt134m-wertu,
            END OF lty_output.


    TYPES   ltt_output TYPE STANDARD TABLE OF lty_output.
...
CLASS zcl_mb5b_select_t134m_01 IMPLEMENTATION.
