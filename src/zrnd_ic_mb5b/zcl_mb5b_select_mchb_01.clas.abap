CLASS ZCL_MB5B_SELECT_MCHB_01 DEFINITION
  PUBLIC
...
TYPES: BEGIN OF imchb,    "aktueller Chargenbestand
        werks TYPE zmchb-werks,
        matnr TYPE zmchb-matnr,
        lgort TYPE zmchb-lgort,
        charg TYPE zmchb-charg,
        clabs TYPE zmchb-clabs,      "frei verwendbarer Chargenbestand
        cumlm TYPE zmchb-cumlm,      "Umlagerungsbestand
        cinsm TYPE zmchb-cinsm,      "Qualitätsprüfbestand
        ceinm TYPE zmchb-ceinm,      "nicht frei verwendbarer Bestand
        cspem TYPE zmchb-cspem,      "gesperrter Bestand
        cretm TYPE zmchb-cretm.      "gesperrter Bestand
*ENHANCEMENT-POINT ehp605_rm07mldd_08 SPOTS es_rm07mlbd STATIC .
TYPES: END OF imchb.


    TYPES   ltt_output TYPE STANDARD TABLE OF imchb.
...
CLASS ZCL_MB5B_SELECT_MCHB_01 IMPLEMENTATION.
