CLASS zcl_mb5b_select_mspr_02 DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    ...
    TYPES: BEGIN OF mspr_typ,
             werks TYPE zmspr-werks,
             lgort TYPE zmspr-lgort,
             matnr TYPE zmspr-matnr,
             sobkz TYPE zmspr-sobkz,
             prlab TYPE zmspr-prlab,
             prins TYPE zmspr-prins,
             prspe TYPE zmspr-prspe,
             prein TYPE zmspr-prein.
*ENHANCEMENT-POINT ehp605_rm07mldd_03 SPOTS es_rm07mlbd STATIC .
    ...
    TYPES:   charg TYPE zmspr-charg.
    TYPES: END OF cmspr_typ.


    TYPES   ltt_output TYPE STANDARD TABLE OF cmspr_typ.
...
CLASS zcl_mb5b_select_mspr_02 IMPLEMENTATION.
