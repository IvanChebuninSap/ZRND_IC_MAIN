CLASS zcl_mb5b_select_msku_02 DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    ...
    TYPES: BEGIN OF msku_typ,
             werks TYPE zmsku-werks,
             matnr TYPE zmsku-matnr,
             sobkz TYPE zmsku-sobkz,
             kulab TYPE zmsku-kulab,
             kuins TYPE zmsku-kuins,
             kuein TYPE zmsku-kuein,
             kuuml TYPE zmsku-kuuml.                        "1421484
*ENHANCEMENT-POINT ehp605_rm07mldd_02 SPOTS es_rm07mlbd STATIC .
    ...
    TYPES:   charg TYPE zmsku-charg.
    TYPES: END OF cmsku_typ.



    TYPES   ltt_output TYPE STANDARD TABLE OF cmsku_typ.
...
CLASS ZCL_MB5B_SELECT_MSKU_02 IMPLEMENTATION.
