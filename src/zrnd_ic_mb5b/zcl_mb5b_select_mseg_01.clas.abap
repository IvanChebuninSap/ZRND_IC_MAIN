CLASS zcl_mb5b_select_mseg_01 DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    ...
    TYPES : BEGIN OF stype_mseg_xauto,                      "n547170
              mblnr TYPE zmseg-mblnr,                       "n547170
              mjahr TYPE zmseg-mjahr,                       "n547170
              zeile TYPE zmseg-zeile,                       "n547170
              matnr TYPE zmseg-matnr,                       "n547170
              xauto TYPE zmseg-xauto,                       "n547170
    ...
    DATA : mt_output    TYPE  stab_mseg_xauto.

ENDCLASS.



CLASS ZCL_MB5B_SELECT_MSEG_01 IMPLEMENTATION.
