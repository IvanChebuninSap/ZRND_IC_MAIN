CLASS ZCL_MB5B_SELECT_MARD_01 DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
   ...
   TYPES ltt_output TYPE STANDARD TABLE OF zt001w-werks WITH DEFAULT KEY.
...
CLASS ZCL_MB5B_SELECT_MARD_01 IMPLEMENTATION.
