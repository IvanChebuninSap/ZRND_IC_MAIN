CLASS zcl_mb5b_select_mcha_02 DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    ...
    TYPES: BEGIN OF imcha,
             matnr TYPE zmcha-matnr,                        "n1404822
             werks TYPE zmcha-werks,                        "n1404822
             charg TYPE zmcha-charg,                        "n1404822
           END OF imcha.


    TYPES   ltt_output TYPE STANDARD TABLE OF imcha.
...
CLASS ZCL_MB5B_SELECT_MCHA_02 IMPLEMENTATION.
