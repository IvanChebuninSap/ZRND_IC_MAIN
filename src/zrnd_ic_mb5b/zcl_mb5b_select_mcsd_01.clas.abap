CLASS zcl_mb5b_select_mcsd_01 DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    ...
    TYPES: BEGIN OF mcsd_typ,
             werks TYPE zmcsd-werks,
             lgort TYPE zmcsd-lgort,
             matnr TYPE zmcsd-matnr,
             sobkz TYPE zmcsd-sobkz,
             sdlab TYPE zmcsd-sdlab,
             sdins TYPE zmcsd-sdins,
             sdspe TYPE zmcsd-sdspe,
             sdein TYPE zmcsd-sdein,
             charg TYPE zmcsd-charg.
    TYPES: END OF mcsd_typ.


    TYPES   ltt_output TYPE STANDARD TABLE OF mcsd_typ.
...
CLASS zcl_mb5b_select_mcsd_01 IMPLEMENTATION.
